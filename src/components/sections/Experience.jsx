            ...
            <div className="space-y-8 relative before:absolute before:inset-0 before:ml-5 before:-translate-x-px md:before:mx-auto md:before:translate-x-0 before:h-full before:w-0.5 before:bg-gradient-to-b before:from-transparent before:via-brand-gray before:to-transparent">
                {experiences.map((exp, index) => (
                    <div key={index} className="relative flex items-center justify-between md:justify-normal md:odd:flex-row-reverse group is-active">
                        ...
                        {/* Timeline content */}
                        <div className="w-[calc(100%-4rem)] md:w-[calc(50%-3rem)] p-6 rounded-2xl bg-brand-gray/30 border border-gray-800 hover:border-brand-purple/50 transition-colors shadow-lg">
                            <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between mb-2">
                                ...
                                <time className="hidden sm:block text-sm text-brand-purple font-medium whitespace-nowrap ml-4">{exp.duration}</time>
                            </div>
                            <div className="mb-4">
                            ...
                            {exp.highlights.length > 0 && (
                                <ul className="space-y-2 text-gray-400 text-sm ml-4 list-disc marker:text-brand-purple/50">
