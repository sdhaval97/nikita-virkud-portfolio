...
export default function TechStack() {
    return (
        <section className="py-16 border-t border-brand-gray">
            <div className="flex items-center space-x-3 mb-12 flex-col text-center justify-center">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                {techCategories.map((category, index) => (
                    <div key={index} className="bg-brand-gray/30 rounded-2xl p-6 border border-gray-800 hover:border-brand-purple/50 transition-all hover:-translate-y-1 shadow-xl">
